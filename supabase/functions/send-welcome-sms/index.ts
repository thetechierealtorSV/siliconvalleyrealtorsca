...
serve(async (req) => {
  ...
  try {
    ...
    const body =
`Hi ${firstName}, this is Nikolaenko Property Group. Thanks for reaching out — a senior agent will follow up shortly to help with your Bay Area search or valuation.
